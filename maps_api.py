...
url = 'https://maps.googleapis.com/maps/api/geocode/json?address='+ kor_url +'&key=AIzaSyAJn_4TI5tLuq3Mx6Tg5-Ib4U6BYi8Fl7c&language=ko'
 
req = Request(url, headers={ 'X-Mashape-Key': 'AIzaSyAJn_4TI5tLuq3Mx6Tg5-Ib4U6BYi8Fl7c' })
